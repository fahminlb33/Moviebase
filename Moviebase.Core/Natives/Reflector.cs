...
namespace Moviebase.Core.Natives
{
    ...
    public class Reflector
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="nameSpace">The nameSpace containing types to be used</param>
        ...
        /// Constructor
        /// </summary>
        /// <param name="assemblyName">A specific assembly name (used if the assembly name does not tie exactly with the nameSpace)</param>
        /// <param name="nameSpace">The nameSpace containing types to be used</param>
        ...
        public Type GetType(string typeName)
        {
            ...
            if (names.Length > 0)
                type = _assembly.GetType(_namespace + "." + names[0]);
        ...
        public object CallAs2(Type type, object obj, string func, object[] parameters)
        {
            ...
            Debug.Assert(methInfo != null, "methInfo != null");
        ...
        /// <summary>
        /// Returns assemblyName enum value
        /// </summary>
